    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply_to', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='forum.Comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thread_posts', models.ManyToManyField(blank=True, related_name='_maintopic_thread_posts_+', to='forum.Comment')),
